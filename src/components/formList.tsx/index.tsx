...
const FormList = () => {
  return (
    <div className="flex w-250 pt-18 pb-12 px-8 flex-col justify-end items-center gap-10 rounded-xl bg-[#F7F6FB]">
      ...
      <div className="flex py-2.5 px-5 justify-center items-center gap-2.5 rounded-lg bg-[#7C5CFF] active:bg-[#6344DD] typo-title text-white text-center tracking-widest cursor-pointer">
        검색
      </div>
    </div>
  );
