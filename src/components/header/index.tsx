  ...
  return (
    <div className="sticky top-0 z-50 flex w-full h-20 justify-between items-center border-b border-[#dad9d9] px-5 bg-white">
      ...
      <div className="flex justify-center items-center gap-5 self-stretch">
        <div
          className="flex w-24 h-9 flex-col justify-center text-center cursor-pointer typo-body"
        ...
        <div className="flex w-24 h-9 flex-col justify-center text-center cursor-not-allowed typo-body opacity-40">
          <div className="text-black">트렌드</div>
        </div>
      </div>
      <div className="flex w-40 h-9 justify-center items-center text-black typo-body">
        name님 어서오세요!
      </div>
