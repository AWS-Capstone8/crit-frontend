  ...
  return (
    <div className="inline-flex w-full h-102 py-6 pl-6 pr-5 gap-5 rounded-xl bg-[#fff] border border-[#A594F9]">
      <div className="flex flex-1 flex-col gap-4">
        ...
        <div className="w-full h-full overflow-y-auto px-3 py-4 rounded-xl bg-[#FAFAFA] border border-[#A594F9] typo-label2 text-black whitespace-pre-line break-keep leading-6 script-scroll">
